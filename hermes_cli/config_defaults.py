...
OPTIONAL_ENV_VARS = {
    ...
    "KIMI_CN_API_KEY": _prov("Kimi / Moonshot China API key", "Kimi (China) API key",
        "https://platform.moonshot.cn/"),
    "KILOCODE_API_KEY": _prov("Kilo Code API key — one key, hundreds of models via the Kilo Gateway",
        "Kilo Code API key", "https://kilo.ai/"),
    "KILOCODE_BASE_URL": _base_url("Kilo Code"),

...
_BAR = "=" * 68
_UPSTREAM_ADD_CMD = "git remote add upstream https://github.com/Yarpii/hermes-agent.git"
...
OFFICIAL_REPO_URLS = {
    "https://github.com/Yarpii/hermes-agent.git",
    "git@github.com:Yarpii/hermes-agent.git",
    "https://github.com/Yarpii/hermes-agent",
    "git@github.com:Yarpii/hermes-agent",
}
OFFICIAL_REPO_URL = "https://github.com/Yarpii/hermes-agent.git"
...
def _offer_upstream_remote(git_cmd: list[str], cwd: Path, *, assume_yes: bool, input_fn) -> bool:
    ...
    print(
        ...
        "  This means you may miss updates from Yarpii/hermes-agent.\n"
    )
    ...
    if not _add_upstream_remote(git_cmd, cwd):
        ...
        return False
    print("  ✓ Added upstream: https://github.com/Yarpii/hermes-agent.git")
    return True

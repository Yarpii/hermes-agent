...
TIPS = [
    ...
    "/plan writes a markdown implementation plan to .hermes/plans/ without executing anything.",
    # --- Cron & Scheduling ---
    ...
    "Skills from trusted repos (Yarpii) get a 'trusted' security level; community skills get extra scanning.",

 ...
 *
 * A public install can end up with `origin=git@github.com:Yarpii/hermes-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/Yarpii/hermes-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/yarpii/hermes-agent'

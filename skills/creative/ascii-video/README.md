...
Built for [Hermes Agent](https://github.com/Yarpii/hermes-agent). Usable in any coding agent. Canonical source lives here; synced to [`Yarpii/hermes-agent/skills/creative/ascii-video`](https://github.com/Yarpii/hermes-agent/tree/main/skills/creative/ascii-video) via PR.
